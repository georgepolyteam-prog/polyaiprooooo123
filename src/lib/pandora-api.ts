...
const MOCK_MARKETS: PandoraMarket[] = [
  ...
  {
    id: 'dogecoin-1-dollar',
    pollAddress: '0x1134567890abcdef1234567890abcdef12345678',
    marketAddress: '0x9bcdef1234567890abcdef1234567890abcdef12',
    question: 'Will Dogecoin reach $1 in 2025?',
    currentOddsYes: 18,
    currentOddsNo: 82,
    totalVolume: '980000000000',
    totalLiquidity: '294000000000',
    totalTrades: 2341,
    status: 'active',
    category: 'Crypto',
    endDate: Date.now() + (300 * 24 * 60 * 60 * 1000),
  ...
  {
    id: 'nba-lakers-championship',
    pollAddress: '0x2234567890abcdef1234567890abcdef12345679',
    marketAddress: '0xabcdef1234567890abcdef1234567890abcdef13',
    question: 'Will the Lakers win NBA Championship 2025?',
    currentOddsYes: 12,
    currentOddsNo: 88,
    totalVolume: '1450000000000',
    totalLiquidity: '435000000000',
    totalTrades: 1876,
    status: 'active',
    category: 'Sports',
  ...
  {
    id: 'tesla-robotaxi-2025',
    pollAddress: '0x3334567890abcdef1234567890abcdef12345678',
    marketAddress: '0xbbcdef1234567890abcdef1234567890abcdef14',
    question: 'Will Tesla launch commercial Robotaxi in 2025?',
    currentOddsYes: 34,
    currentOddsNo: 66,
    totalVolume: '1850000000000',
    totalLiquidity: '555000000000',
    totalTrades: 2456,
    status: 'active',
    category: 'Tech',
    endDate: Date.now() + (365 * 24 * 60 * 60 * 1000),
  ...
  {
    id: 'ufc-310-winner',
    pollAddress: '0x4434567890abcdef1234567890abcdef12345678',
    marketAddress: '0xccbdef1234567890abcdef1234567890abcdef15',
    question: 'Will Jon Jones win UFC 310?',
    currentOddsYes: 72,
    currentOddsNo: 28,
    totalVolume: '380000000000',
    totalLiquidity: '114000000000',
    totalTrades: 567,
    status: 'active',
    category: 'Sports',
  ...
  {
    id: 'uk-election-2025',
    pollAddress: '0x5534567890abcdef1234567890abcdef12345678',
    marketAddress: '0xddbdef1234567890abcdef1234567890abcdef16',
    question: 'Will Labour win UK General Election?',
    currentOddsYes: 78,
    currentOddsNo: 22,
    totalVolume: '2100000000000',
    totalLiquidity: '630000000000',
    totalTrades: 3421,
    status: 'active',
    category: 'Politics',
  ...
  {
    id: 'squid-game-season-3',
    pollAddress: '0x6634567890abcdef1234567890abcdef12345678',
    marketAddress: '0xeebdef1234567890abcdef1234567890abcdef17',
    question: 'Will Squid Game Season 3 release in 2025?',
    currentOddsYes: 65,
    currentOddsNo: 35,
    totalVolume: '290000000000',
    totalLiquidity: '87000000000',
    totalTrades: 412,
    status: 'active',
    category: 'Entertainment',
    endDate: Date.now() + (365 * 24 * 60 * 60 * 1000),
  ...
  {
    id: 'avax-100',
    pollAddress: '0x7734567890abcdef1234567890abcdef12345678',
    marketAddress: '0xffbdef1234567890abcdef1234567890abcdef18',
    question: 'Will Avalanche reach $100 by end of 2025?',
    currentOddsYes: 29,
    currentOddsNo: 71,
    totalVolume: '620000000000',
    totalLiquidity: '186000000000',
    totalTrades: 789,
    status: 'active',
    category: 'Crypto',
    endDate: Date.now() + (365 * 24 * 60 * 60 * 1000),
  ...
  {
    id: 'india-mars-mission',
    pollAddress: '0x8834567890abcdef1234567890abcdef12345678',
    marketAddress: '0x00bdef1234567890abcdef1234567890abcdef19',
    question: 'Will ISRO launch Mars mission by 2026?',
    currentOddsYes: 41,
    currentOddsNo: 59,
    totalVolume: '480000000000',
    totalLiquidity: '144000000000',
    totalTrades: 623,
    status: 'active',
    category: 'Science',
    endDate: Date.now() + (600 * 24 * 60 * 60 * 1000),
    createdAt: Date.now() - (55 * 24 * 60 * 60 * 1000),
    marketType: 'AMM',
  },
  {
    id: 'f1-verstappen-2025',
    pollAddress: '0x9934567890abcdef1234567890abcdef12345678',
    marketAddress: '0x11bdef1234567890abcdef1234567890abcdef20',
    question: 'Will Verstappen win F1 Championship 2025?',
    currentOddsYes: 56,
    currentOddsNo: 44,
    totalVolume: '1670000000000',
    totalLiquidity: '501000000000',
    totalTrades: 2134,
    status: 'active',
    category: 'Sports',
    endDate: Date.now() + (330 * 24 * 60 * 60 * 1000),
    createdAt: Date.now() - (40 * 24 * 60 * 60 * 1000),
    marketType: 'AMM',
  },
];
